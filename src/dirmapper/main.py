...
def main():
    ...
    read_parser.add_argument('-t', '--template', nargs='?', const='generated_template.json', help='Generate a template file in the current working directory (optional: specify the file name)')
    read_parser.add_argument('-o', '--output', type=str, help="The output file to save the directory structure.")
    read_parser.add_argument('-fo', '--file_only', action='store_true', help="Output only the directory structure to the console.")
    read_parser.add_argument('-if', '--ignore_file', type=str, default='.mapping-ignore', help="The ignore file listing directories and files to ignore.")
    read_parser.add_argument('-ng', '--no_gitignore', action='store_true', help="Do not include patterns from .gitignore.")
    ...
    read_parser.add_argument('-f', '--format', choices=FORMATTER_MAP.keys(), default='plain', help="Choose the format of the directory structure output.")
    read_parser.add_argument('-i','--ignore', type=str, nargs='*', default=[], help="Additional ignore patterns to exclude.")
    ...
    summarize_parser.add_argument('-f', "--format", type=str, choices=["minimalist", "plain", "html", "json"], default="minimalist", help="Format of the summary")
    summarize_parser.add_argument('-o', "--output", type=str, help="Output file to save the summary")
    ...
    write_parser.add_argument('-t', '--template', nargs='?', const='generated_template.json', help='Generate a template file in the current working directory (optional: specify the file name)')
